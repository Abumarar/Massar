...
function getDeploymentDomain() {
  ...
  console.warn(
    'WARNING: No deployment domain found. Defaulting to localhost. Set REPLIT_INTERNAL_APP_DOMAIN, REPLIT_DEV_DOMAIN, or EXPO_PUBLIC_DOMAIN for production builds.',
  );
  return 'localhost';
}
